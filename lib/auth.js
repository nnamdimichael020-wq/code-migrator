...
// paths (signed webhook, or a Checkout Session fetched back from Stripe) —
// never from client input. Stripe ids are merged in when present so a later
// customer portal / cancellation flow has them.
